"""
Day 1, Step 8 - NewsAPI ETL entrypoint: Bronze -> Silver.

Run inside the Spark container, e.g.:
    spark-submit /opt/spark-jobs/etl_newsapi.py \
        --bronze-path s3a://bronze/newsapi/*/newsapi.json \
        --silver-path s3a://silver/newsapi
"""
...
def main() -> None:
    ...
    spark = build_spark_session("etl_newsapi")
    try:
